...
Actualmente, el proyecto continúa desarrollandose, pero ya no trabajando en la 
Universidad Rey Juan Carlos, sino en la Asociación sin ánimo de lucro 
\textbf{Programamos} en la que mi co-tutor, Jesús Moreno, es co-fundador 
junto con José Ignacio Huertas. 
...
El \textbf{lenguaje Python}~\cite{duque2011python}, cuyo nombre es en homenaje a la serie \textit{Monty Python's Flying 
Circus}. Fué 
...
Es destacable indicar que las versiones 2 y 3 son incompatibles entre sí, por el
 gran número de diferencias entre ellas.
...
Todo servidor web necesita una base de datos a la que consulta para salvar
información de los usuarios registrados, ficheros...
