...
\begin{itemize}
 \item La \textit{versión Alpha} fué creada por el alumno Cristian Chushig, su principal 
...
También se ha implementado con la ayuda del proyecto de un usuario de 
...
implementación de Cristian Chushig (versión Alpha) pero que aún no había 
terminado todo su
...
es un proyecto internacional. Hemos recibido feedback de usuarios de todo el 
...
Durante el desarrollo de este proyecto he podidio tomar conciencia de la 
...
\begin{enumerate}[label=\textbf{\arabic{*}.}]
  ...
  \item \textbf{Sistemas Telemáticos I:} Me permitió aprender conceptos básicos
    ...
    mi programa.
  \item \textbf{Sistemas Telemáticos II:} Fue en esta asignatura donde dí el 
...
Durante la carrera había realizado numerosas prácticas similiares
