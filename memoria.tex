...
\vspace{1cm}
La defensa del presente Proyecto Fin de Carrera se realizó el día \qquad$\;\,$ de \qquad\qquad\qquad\qquad \newline de 20CA, siendo calificada por el siguiente tribunal:
...
\vspace{1cm}
\begin{flushright}
Fuenlabrada, a \qquad$\;\,$ de \qquad\qquad\qquad\qquad de 20CA
\end{flushright}
...
proyectos realizados en \textit{Scratch} -lenguaje orientado a la enseñanza-
 aportando \emph{feedback} sobre determinados aspectos relacionados con el 
...
\emph{cloud} de Microsoft llamada Azure y la licencia Apache. Por debajo de ello, tenemos un servidor 
...
Ambos han realizado algunos artículos~\cite{moreno2014automatic} en los que explican
...
resultados en la enseñanza de asignaturas como Inglés, Matemáticas o Filosofía.
...
para organizar proyectos-. Y fueron marcados inicialmente, cuáles eran los objetivos
...
que se muestra en la \textit{Figura~\ref{figure:aplicacion-distribuida}}.
    ...
    \begin{enumerate}[label=\textbf{\arabic{*}.}]
        ...
        residir en el cliente y es con la cual el usuario interactúa. 
...
Cristian se encargó de poner el código abierto de Nathan (getSb2) en Heroku\footnote{\url{https://www.heroku.com/}}
 lo cual nos dio numerosos problemas más tarde. 
